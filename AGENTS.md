...
- Use `docs/combat-system-gap-analysis.md` as the current comparison between GBF wiki combat flow and GLD's implementation. Prefer filling the listed P0/P1 gaps before adding unrelated combat features.
